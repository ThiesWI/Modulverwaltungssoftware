                            ...
                            var kommentare = new List<Kommentar>
    {
        ...
        new Kommentar
        {
            Text = "Abgelehnt durch das Gremium: Die Prüfungsdichte im 2. Semester ist bereits sehr hoch. " +
                   "Eine 120-minütige Klausur wird als unverhältnismäßig angesehen. " +
                   "Wir fordern eine Änderung der Prüfungsform hin zu semesterbegleitenden Leistungen " +
        ...
        new Kommentar
        {
            Text = "Rückgabe (Koordination): Das Modul kann in dieser Form nicht angeboten werden. " +
                   ...
                   "Sicherheitsbelehrung vor der ersten praktischen Übung verpflichtend ist. " +
                   "Bitte fügen Sie den entsprechenden Textbaustein aus dem Arbeitssicherheit-Handbuch ein.",
